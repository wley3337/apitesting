...
document.addEventListener('DOMContentLoaded', () =>{putImageOnScrene()})

function getDiv(){
    return document.getElementById('nasa-img')
}
...
function putImageOnScrene(){
    getImage()
    .then(response => response.json())
    .then(nasaObj => {
        getDiv().appendChild(createImage(nasaObj.url))
    })
}
